...
/**
 * Changes the password of the specified username to the newPassword specified.
 *
 * @public
 * @param {string} username The username of the user whose password is being changed
 * @param {string} newPassword The new password for the user
 * @param {function} callback The callback to execute when the password change is
...
ActiveDirectory.prototype.changePassword = function changePassword (username, newPassword, callback) {
  log.trace('authenticate(%j,%s)', username, isPasswordLoggingEnabled ? newPassword : '********')
  ...
  client.modify(username, new ldap.Change({
    operation: 'replace',
    modification: {
    ...
    const message = util.format('Authentication %s for "%s" as "%s" (password: "%s")',
                              ...
                              this.opts.url, username, isPasswordLoggingEnabled ? newPassword : '********')
    if (err) {
